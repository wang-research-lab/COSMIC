...
from pipeline.submodules.select_direction_2_ace_sysprompt import select_direction, get_refusal_scores
...
def run_pipeline(model_path):
    ...
    model_alias = os.path.basename(model_path) + "-sysprompt-ace"
    ...
    # 3a. Generate and save completions on harmful evaluation datasets
    generate_and_save_completions_for_dataset(cfg, model_base, ablation_fwd_pre_hooks, ablation_fwd_hooks, 'ablation_gennorm', 'harmful', dataset = harmful_test)
    generate_and_save_completions_for_dataset(cfg, model_base, actadd_fwd_pre_hooks, actadd_fwd_hooks, 'actadd_gennorm', 'harmful', dataset = harmful_test)
    ...
    evaluate_completions_and_save_results_for_dataset(cfg, 'ablation_gennorm', "harmful", eval_methodologies=cfg.jailbreak_eval_methodologies)
    evaluate_completions_and_save_results_for_dataset(cfg, 'actadd_gennorm', "harmful", eval_methodologies=cfg.jailbreak_eval_methodologies)
